...
class MonthView @JvmOverloads constructor(
    ...
    private var text2eColor = ContextCompat.getColor(context, R.color.color_2E96F9)
    ...
    private fun onViewClick(event: MotionEvent) {
        ...
        if (position > -1 && position < dayList.size) {
            dayList.get(position).isSclete = true
            invalidate()
...
//                invalidate()
    ...
    public fun getData(): MutableList<DayBean>? {
